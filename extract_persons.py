...
SEED_ALIASES: dict[str, list[str]] = {
    ...
    # ──── 第三批补全 (2026-05-29 黄金标准实证漏识别) ────
    # 来源: recall_verification_final.txt — 生卒年括注 X（YYYY—YYYY） 命中且 v2 未收
    # 学术圈
    "阮元":   ["伯元", "芸台"],            # 1764-1849
    "魏源":   ["默深"],                     # 1794-1857
    "朱次琦": ["子襄", "九江先生"],         # 1807-1882, 康有为之师
    "陈澧":   ["兰甫", "东塾"],             # 1810-1882
    "杨长年": ["健行", "杨朴庵"],           # 1811-1893
    "曾纪泽": ["纪泽", "劼刚"],             # 1830-1890
    "李文田": ["畲光", "芍农"],             # 1834-1895
    "杨仁山": ["杨文会"],                   # 1837-1911, 佛学居士 (避免"仁山"撞别人)
    "廉泉":   ["南湖"],                     # 1868-1931
    "徐珂":   ["仲可"],                     # 1869-1928
    "缪荃孙": ["艺风"],                     # 1844-1919
    "闵尔昌": ["葆之"],                     # 1872-1948
    ...
    "谭嗣同": ["复生", "壮飞"],             # 1865-1898
    "孙儆":   ["敬臣"],                     # 1866-1952
    "井上哲次郎": [],                        # 1856-1944, 日本哲学家
    # 艺术圈
    "杨古酝": ["葆光", "苏庵"],             # 1830-1912
    "赵穆":   ["仲穆", "穆甫"],             # 1845-1894
    "罗振玉": ["雪堂", "叔言", "贞松老人"], # 1866-1940
    "邵章":   ["伯褧"],                     # 1872-1953
    "陶牧":   ["伯荪"],                     # 1874-1934 (避免"小柳"过宽)
    "童大年": ["心安", "心盦"],             # 1874-1955
    "李健":   ["仲干", "鹤庐"],             # 1881-1956
    "邓椿澍": ["春澍"],                     # 1884-1954 (青城会撞青城山)
    "潘琳":   [],                           # 1887-1960, 寓日画家
    "卢前":   ["冀野"],                     # 1905-1951, 词曲学家
    "王名准": ["伯尹"],                     # 1910-1949
    "伍德彝": [],                           # 1864-1927
    "铃木松年": [],                          # 1848-1918, 日本京都派画家
    "内海吉堂": ["内海复", "休卿"],          # 1850-1923, 日本鉴赏家
    "姚光":   ["石子"],                     # 1891-1945, 南社
    # 政治/社会
    "冯煦":   ["梦华", "蒿叟"],             # 1843-1927
    "李平书": [],                           # 1854-1927
    "严复":   ["几道"],                     # 1854-1921
    "志贺重昂": [],                          # 1863-1927, 日本国粹主义者
    "沈宗畸": [],                           # 1865-1926
    "方旭":   ["鹤斋"],                     # 1852-1940
    "蒋方震": ["百里", "方震"],             # 1882-1938
    "陶广":   ["恩安"],                     # 1888-1951
...
# ───────────────────────────────────────────────────────────
# 已知生年补丁 (文本中未带生卒年括注的人物)
# 用于 Step D 过滤: 早于此人生年-2 年的命中视为引文/追述, 不计入
# ───────────────────────────────────────────────────────────
EXTRA_BIRTH_YEARS = {
    # 后世研究者
    "夏承焘": 1900,   # 1900-1986 词学家, 早期事件常引其考证
    "王伯敏": 1924,   # 1924-2013
    "卞孝萱": 1924,   # 1924-2009
    "石谷风": 1919,   # 1919-2019
    "汪世清": 1922,   # 1922-2003
...
def main():
    ...
    # 合并已知生年: auto_detect 的 + 手工补的 EXTRA_BIRTH_YEARS
    # 用于过滤"早于生年-2 年"的引文式命中
    person_birth = {n: b for n, (b, d) in birth_death.items()}
    for n, b in EXTRA_BIRTH_YEARS.items():
        if n not in person_birth:
            person_birth[n] = b
    ...
    for evt in events:
        ...
        for std in known:
            # 过滤: 早于此人生年-2 年的命中视为引文/追述, 不计入活跃记录
            if std in person_birth and year < person_birth[std] - 2:
                continue
